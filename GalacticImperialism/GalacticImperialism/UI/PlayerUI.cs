...
namespace GalacticImperialism
{
    ...
    class PlayerUI
    {
        ...
        UnitProductionTab unitProductionTabObject;
        ...
        public void LoadContent(ContentManager Content, Texture2D playerFlag, Texture2D white)
        {
            ...
            Castellar12 = Content.Load<SpriteFont>("Sprite Fonts/Castellar12Point");
            ...
            unitProductionTabObject = new UnitProductionTab(Content, whiteTexture);
        ...
        public void Update(Texture2D playerFlagTexture, MouseState mouse, MouseState oldMouse, KeyboardState kb, KeyboardState oldKb)
        {
            ...
            if (planetManagementMenuOpen)
            {
                ...
                if (tabButtons[2].isClicked)
                {
                    tabSelected = Tabs.UnitProduction;
                }
